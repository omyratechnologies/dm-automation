    ...
    return (
      <div className="relative overflow-hidden rounded-xl bg-card border border-red-500/20 p-6">
        <div className="text-center py-8">
          ...
          <button 
            onClick={() => refetch()} 
            className="inline-flex min-h-11 items-center gap-2 rounded-lg bg-gradient-brand px-4 py-2 text-sm font-medium text-white transition-colors hover:brightness-95"
          >
      ...
      <div className="relative overflow-hidden rounded-xl bg-muted border border-border p-6">
        ...
        {stats.total > 0 ? (
          ...
          <div className="relative z-10 text-center py-8">
            ...
            <a href={`/dashboard/automations`} className="inline-flex min-h-11 items-center gap-2 rounded-lg bg-gradient-brand px-4 py-2 text-sm font-medium text-white transition-colors hover:brightness-95">
              <svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
